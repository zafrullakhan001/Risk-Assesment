...
final class Database
{
    ...
    private static function migrate(PDO $pdo): void
    {
        ...
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_user_notifications_user_id ON user_notifications (user_id)');
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_user_notifications_user_unread ON user_notifications (user_id, read_at)');
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_user_notifications_created_at ON user_notifications (created_at)');
        ...
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_catalog_share_links_token_hash ON catalog_share_links (token_hash)');
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_catalog_share_links_revoked ON catalog_share_links (revoked_at)');
        ...
        $pdo->exec('CREATE INDEX IF NOT EXISTS idx_sharepoint_search_tags_label ON sharepoint_search_tags (label)');
        $pdo->exec(
