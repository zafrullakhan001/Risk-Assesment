    ...
    <div class="shell upload-page">
        <header class="topbar topbar-uplift">
            ...
            <div class="topbar-actions">
                ...
                <a class="button ghost home-link" data-menu-tone="sky" href="#find-projects"><span class="topbar-menu-emoji" aria-hidden="true">🔎</span>Find by name</a>
                <a class="button ghost home-link" data-menu-tone="mint" href="#upload"><span class="topbar-menu-emoji" aria-hidden="true">📤</span>Upload</a>
