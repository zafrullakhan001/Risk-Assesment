    ...
    <div class="shell upload-page template-library-page">
        <header class="topbar topbar-uplift">
            ...
            <div class="topbar-actions">
                ...
                <a class="button ghost home-link is-active" data-menu-group="risk" data-menu-tone="lavender" data-nav-dest="templates" href="templates.php" aria-current="page" title="Browse and manage assessment workbook templates"><span class="topbar-menu-emoji" aria-hidden="true">📚</span>Templates</a>
                <?php endif; ?>
